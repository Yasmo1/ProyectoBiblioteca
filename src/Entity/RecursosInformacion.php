...
class RecursosInformacion
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\CategoriasRecursosInformacion", inversedBy="recursosInformacions")
     */
    private $categoria;
    ...
    public function getCategoria(): ?CategoriasRecursosInformacion
    {
