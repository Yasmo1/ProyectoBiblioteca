 ...
 */
final class Version20180607120050 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pii (id INT AUTO_INCREMENT NOT NULL, jefe_proyecto_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, alias VARCHAR(255) NOT NULL, descripcion LONGTEXT DEFAULT NULL, INDEX IDX_2BE1B850E47E8F6F (jefe_proyecto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
