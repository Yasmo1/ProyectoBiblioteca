 ...
 */
final class Version20180607091610 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE actividad_postgrado (id INT AUTO_INCREMENT NOT NULL, tipoactividadpostgrado_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, fechainicio DATETIME NOT NULL, fechafin DATETIME NOT NULL, INDEX IDX_80D93EAF33D32E18 (tipoactividadpostgrado_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE actividad_postgrado ADD CONSTRAINT FK_80D93EAF33D32E18 FOREIGN KEY (tipoactividadpostgrado_id) REFERENCES tipo_actividad_postgrado (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE actividad_postgrado DROP FOREIGN KEY FK_80D93EAF33D32E18');
